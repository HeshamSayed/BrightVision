...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['message'])) {
	...
	try {
		...
		$mail->Username   = 'jobs@brightvision-tech.com';                //'a.abdelfatah.100@gmail.com';                     // SMTP username
		$mail->Password   = 'Jobs1234567890';               //'bxxpyhkudxpsxllt';                               // SMTP password
		...
		$mail->addAddress('jobs@brightvision-tech.com');               // Name is optional
